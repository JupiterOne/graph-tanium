...
export type DirectConnectCloseInput = {
  connectionID: Scalars['ID'];
};

export type DirectConnectClosePayload = {
  __typename?: 'DirectConnectClosePayload';
  result: Scalars['Boolean'];
};

export enum DirectConnectConnectionStatus {
...
export type DirectConnectConnectionStatusInput = {
  connectionID: Scalars['ID'];
};

export type DirectConnectConnectionStatusPayload = {
  __typename?: 'DirectConnectConnectionStatusPayload';
  status: DirectConnectConnectionStatus;
};

export type DirectConnectEndpointInput = {
  connectionID: Scalars['ID'];
};

export type DirectConnectOpenInput = {
  endpointID: Scalars['ID'];
};

export type DirectConnectOpenPayload = {
  __typename?: 'DirectConnectOpenPayload';
  connectionID: Scalars['ID'];
  status: DirectConnectConnectionStatus;
};
...
export type DirectConnectPingInput = {
  connectionID: Scalars['ID'];
};

export type DirectConnectPingPayload = {
  __typename?: 'DirectConnectPingPayload';
  result: Scalars['Boolean'];
};

export type DirectConnectProcessTerminateInput = {
  connectionID: Scalars['ID'];
  name: Scalars['String'];
  pid: Scalars['Int'];
  signal: Signal;
...
export type DirectConnectProcessTerminatePayload = {
  __typename?: 'DirectConnectProcessTerminatePayload';
  result: Scalars['Boolean'];
};
...
export type EndpointComplianceComplianceFinding = {
  ...
  firstFoundDate?: Maybe<Scalars['Date']>;
...
export type EndpointComplianceCveFinding = {
  ...
  absoluteFirstFoundDate?: Maybe<Scalars['Date']>;
...
export enum FilterField {
  ...
  EndpointComplianceComplianceFindingsFirstFoundDate = 'ENDPOINT_COMPLIANCE_COMPLIANCE_FINDINGS_FIRST_FOUND_DATE',
  EndpointComplianceComplianceFindingsId = 'ENDPOINT_COMPLIANCE_COMPLIANCE_FINDINGS_ID',
  EndpointComplianceComplianceFindingsLastScanDate = 'ENDPOINT_COMPLIANCE_COMPLIANCE_FINDINGS_LAST_SCAN_DATE',
  ...
  EndpointComplianceCveFindingsAbsoluteFirstFoundDate = 'ENDPOINT_COMPLIANCE_CVE_FINDINGS_ABSOLUTE_FIRST_FOUND_DATE',
  ...
  EndpointComplianceCveFindingsLastScanDate = 'ENDPOINT_COMPLIANCE_CVE_FINDINGS_LAST_SCAN_DATE',
...
export type Mutation = {
  ...
  directConnectClose: DirectConnectClosePayload;
  directConnectOpen: DirectConnectOpenPayload;
  directConnectPing: DirectConnectPingPayload;
  directConnectProcessTerminate: DirectConnectProcessTerminatePayload;
...
export type MutationDirectConnectCloseArgs = {
  input: DirectConnectCloseInput;
};

export type MutationDirectConnectOpenArgs = {
  input: DirectConnectOpenInput;
};

export type MutationDirectConnectPingArgs = {
  input: DirectConnectPingInput;
};

export type MutationDirectConnectProcessTerminateArgs = {
...
export type Query = {
  ...
  directConnectConnectionStatus: DirectConnectConnectionStatusPayload;
  directConnectEndpoint?: Maybe<DirectConnect>;
...
export type QueryDirectConnectConnectionStatusArgs = {
  input: DirectConnectConnectionStatusInput;
};

export type QueryDirectConnectEndpointArgs = {
...
export enum StabilityLevel {
  ...
  ExperimentalActiveDevelopment = 'EXPERIMENTAL_ACTIVE_DEVELOPMENT',
  ExperimentalEarlyDevelopment = 'EXPERIMENTAL_EARLY_DEVELOPMENT',
  ExperimentalReleaseCandidate = 'EXPERIMENTAL_RELEASE_CANDIDATE',
  Legacy = 'LEGACY',
  Stable = 'STABLE',
}
